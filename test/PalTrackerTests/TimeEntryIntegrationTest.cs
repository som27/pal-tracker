...
namespace PalTrackerTests
{
    ...
    public class TimeEntryIntegrationTest
    {
        ...
        public void Read()
        {
            ...
            var response = _testClient.GetAsync($"/time_entries/{id}").Result;
        ...
        public void Create()
        {
            ...
            var response = _testClient.PostAsync("/time_entries", SerializePayload(timeEntry)).Result;
            var responseBody = JObject.Parse(response.Content.ReadAsStringAsync().Result);
        ...
        public void List()
        {
            ...
            var response = _testClient.GetAsync("/time_entries").Result;
        ...
        public void Update()
        {
            ...
            var putResponse = _testClient.PutAsync($"/time_entries/{id}", SerializePayload(updated)).Result;
            var getResponse = _testClient.GetAsync($"/time_entries/{id}").Result;
            var getAllResponse = _testClient.GetAsync("/time_entries").Result;
        ...
        public void Delete()
        {
            ...
            var deleteResponse = _testClient.DeleteAsync($"/time_entries/{id}").Result;
            var getResponse = _testClient.GetAsync($"/time_entries/{id}").Result;
            var getAllResponse = _testClient.GetAsync("/time_entries").Result;
